...
public class TesteFocus {
	...
	public static void enviarEmail() throws JSONException {
		String login = "Token_enviado_pelo_suporte";
		/* Substituir pela sua identificação interna da nota. */
		String ref = "12345";

		/*
		 * Para ambiente de produção use a variável abaixo: String server =
		...
		/*
		 * As três linhas abaixo imprimem as informações retornadas pela API. Aqui o seu
		 * sistema deverá interpretar e lidar com o retorno.
		 */
